[Cozy][cozy] SFR RED box konnector
=================================
...
A connector to retrieve your SFR RED box bills and billing data and save them into your Cozy.
...
git://github.com/cozy/cozy-konnector-redbox.git#build
...
SFR RED box cozy konnector is developed by @doubleface and distributed under the [AGPL v3 license][agpl-3.0].
